# CSS helpers<i-c o='ph:flask'></i-c>
...
[Adoptable stylesheets](https://developer.mozilla.org/en-US/docs/Web/API/Document/adoptedStyleSheets) offer a modular way to share CSS between your HTML Custom Elements and/or the light DOM.  
...
This helper is an interpretation of the ["Open stylable" idea](https://github.com/WICG/webcomponents/issues/909).
...
Inspired by the first implementation of this [explainer](https://github.com/MicrosoftEdge/MSEdgeExplainers/blob/main/ShadowDOM/explainer.md).
...
See the [Minimal Bootstrap/Tailwind template](https://github.com/gracile-web/starter-projects/tree/main/templates/minimal-bootstrap-tailwind) for a full working example.
...
export const document = () => html`
  ...
  <html lang="en">
    <head>
      ...
      <!-- NOTE: '<adopt-global-styles>' will pick up all CSS '<link>'s for this page that'll finish in your bundle. -->
      <link
        rel="stylesheet"
      ...
      <link rel="stylesheet" href="..." />
      <!-- NOTE: Enabling '<adopt-global-styles>' in Custom Elements shadow hosts. -->
      ${GlobalStylesProvider()}

      <!-- NOTE: 2. Declarative shadow DOM style sharing -->
      <!-- NOTE: Specifiers are unique. They are referenced where you need to cherry pick them. -->
      ...
      <!-- NOTE: Enabling '<adopted-style sheets="/x.css, /y.css">' in CEs shadow hosts. -->
...
export class MyGreetingsAdopted extends LitElement {
  ...
  render() {
    return html`
      <!-- NOTE: These are the sheets specifiers you defined before, in the document. -->
...
// @filename: ./src/features/my-greetings-global-styles.ts
...
Note that at one point, browsers could implement a leaner way to indicate that we want to adopt some sheets,
for specific custom elements, in a declarative way.
