...
const styles = {
	...
	container: styled.div`
		...
		background-image: radial-gradient(
			...
			${tokens.slColorSky_50} 50%,
			${tokens.slColorSky_200} 100%
		); /* ,
      linear-gradient(
        90deg,
        ${tokens.slColorSky_50} 0px,
        ${tokens.slColorEmerald_900} 50%,
	...
	mainTitle: styled.div`
		...
		color: ${tokens.slColorEmerald_900};
		font-size: 60px;
		text-overflow: ellipsis;
		overflow: hidden;
		white-space: nowrap;
	...
	description: styled.div`
		...
		width: 100%;
		overflow: hidden;
		border-left: 5px solid ${tokens.slColorEmerald_950};
