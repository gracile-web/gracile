...
export function errorInline(error: Error): ServerRenderedTemplate {
	return html`<!--  --></a>
  <div data-ssr-error>
...
const minimalStyles = (): ServerRenderedTemplate =>
	html`<style>
		html {
...
const logo = (): ServerRenderedTemplate =>
	/* prettier-ignore */
...
export function builtIn404Page(
	path: string,
	development = false,
...
export function builtInErrorPage(
	name = 'Error',
	development = false,
): ServerRenderedTemplate {
