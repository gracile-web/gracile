...
export const tailwindDemoContent = () => html`
	<div class="antialiased text-gray-900 dark:bg-gray-900">
		<div
			class="px-4 py-10 max-w-3xl mx-auto sm:px-6 sm:py-12 lg:max-w-4xl lg:py-16 lg:px-8 xl:max-w-6xl"
		>
			<article>
				<h1 class="sr-only">Tailwind CSS Typography</h1>
				<div class="space-y-10 sm:space-y-12 lg:space-y-20 xl:space-y-24">
					...
					>
						<svg class="h-6 sm:h-8" fill="none" viewBox="0 0 297 24">
							<path
								class="fill-sky-400"
								fill-rule="evenodd"
						...
						<div>
							<a
								...
								class="inline-flex items-center py-2 px-3 space-x-2 rounded-md bg-gray-800 text-gray-300 text-sm leading-5 font-medium shadow-lg hover:bg-gray-700 transition ease-in-out duration-100 dark:text-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600"
								><svg
					...
					>
						...
						<p>
							...
							<code>p</code> element in a piece of your dashboard UI. And I
							doubt you really want your blog posts to use the user-agent styles
...
&lt;/article&gt;
						...
						<ul>
							...
							<li>
								<p>
									<strong
										>Since this is a list, I need at least two items.</strong
									>
								</p>
								<p>
							...
							<li>
								...
								<p>
									...
									as well include it. I'm going to press <kbd>Enter</kbd> now.
								</p>
							</li>
						</ul>
						<p>
  ...
  plugins: [],
						...
						<p>
							Well, that's not exactly true, we first released this plugin back
							in 2020 and it took three years before we added description lists.
							But they're here now, so let's just be happy about that<!-- -->…<!-- -->okay?
						...
						<dl>
							...
							<dd>
								...
								elit. Culpa, voluptas ipsa quia excepturi, quibusdam natus
								exercitationem sapiente tempore labore voluptatem.
							</dd>
							<dt>Why can't you hear a pterodactyl go to the bathroom?</dt>
							<dd>
								Because the pee is silent. Lorem ipsum dolor sit amet,
								consectetur adipisicing elit. Ipsam, quas voluptatibus ex culpa
								ipsum, aspernatur blanditiis fugiat ullam magnam suscipit
								deserunt illum natus facilis atque vero consequatur! Quisquam,
								debitis error.
							</dd>
						</dl>
